...
class Custom_FPN(SegmentationModel,MultiTaskModel):
    ...
    def __init__(
        ...
        # =================================================================
        # VVVVVVVV 在这里加入我们的调试打印 VVVVVVVV
        print("\n\n" + "="*50)
        print("--- DEBUGGING Custom_FPN INITIALIZATION ---")
        print(f"    Received 'classes' parameter: {classes}")
        print(f"    Received 'classes_grouping' parameter: {classes_grouping}")
        # ^^^^^^^^ 在这里加入我们的调试打印 ^^^^^^^^
        # =================================================================
        ...
        if not self.classes_grouping:
            # =================================================================
            # VVVVVVVV 在这里加入我们的调试打印 VVVVVVVV
            print(f"    [INFO] Building SINGLE-HEAD model with {classes} output channels.")
            # ^^^^^^^^ 在这里加入我们的调试打印 ^^^^^^^^
            # =================================================================
            ...
            # =================================================================
            # VVVVVVVV 在这里加入我们的调试打印 VVVVVVVV
            head1_ch = len(classes_grouping[0])
            head2_ch = len(classes_grouping[1])
            print(f"    [INFO] Building MULTI-HEAD model.")
            print(f"    [INFO] Head 1 will have {head1_ch} channels.")
            print(f"    [INFO] Head 2 will have {head1_ch} channels.")
            print(f"    [INFO] Expected total output channels from torch.cat: {head1_ch + head2_ch}")
            # ^^^^^^^^ 在这里加入我们的调试打印 ^^^^^^^^
            # =================================================================
