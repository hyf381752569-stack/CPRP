...
# ------------------------- 公共环境变量 -------------------------
export OUTPUT_DIR="/data/hyf/dataset/exp/ARFGMM-2B"
...
# =================================================================
echo "开始真实数据训练..."
export DATASET=artf_clothes
export ARTF_CLOTHES_DIR="/home/yufan/project/data/Vicos/dataset/aRTFClothes"
export TRAIN_SIZE=768
export TEST_SIZE=768

# 从预训练模型加载权重
PRETRAINED_MODEL="/home/yufan/project/code/CeDiRNet/exp/ARFGMM-2B/mujoco/backbone=tu-convnext_base/modeling=gaussian_mixture/mixtures=2/num_train_epoch=10/depth=False/multitask_weight=off/checkpoint.pth"
